...
res30: at.logic.gapt.formats.tptp.TptpFile =
fof(ant_0, axiom, p('0')).
...
problem: at.logic.gapt.proofs.HOLSequent = ∀x ∀y (x:a) = y, ∀x f(f(x:b): b) = x ⊢ ∃y (c:b) = f(y)
...
res49: Option[at.logic.gapt.models.PropositionalModel] =
Some(a:o -> false
b:o -> false
c:o -> true)
...
res50: Option[at.logic.gapt.proofs.resolution.ResolutionProof] =
...
∀x_0 (f(x_0) = 0 ∨ f(x_0) = s(0))
  ...
  +^{M(s(M(x_1, x_2)), s(M(s(M(x_1, x_2)), x_3)))}
    ((f(M(s(M(x_1, x_2)), s(M(s(M(x_1, x_2)), x_3)))) = 0)- ∨
      (f(M(s(M(x_1, x_2)), s(M(s(M(x_1, x_2)), x_3)))) = s(0))-)...
